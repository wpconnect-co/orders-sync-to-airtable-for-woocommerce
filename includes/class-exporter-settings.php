...
/**
 * Class Exporter_Settings
 */
class Exporter_Settings extends Abstract_Settings {
	/**
	 * WP option slug
	 *
	 * @var string
	 */
	protected $option_slug = 'orders_sync_to_airtable_for_woocommerce_exporter_settings';
